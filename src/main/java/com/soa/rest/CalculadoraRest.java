...
public class CalculadoraRest {
    ...
    @Autowired
    private CalculadoraBusiness business;
    
    @PostMapping("/calculadora")
    public ResponseEntity<SalidaCalculadora> calcular(@RequestBody EntradaCalculadora entradaCalculadora){
        ResponseEntity<SalidaCalculadora> re = null;
        
        SalidaCalculadora salidaCalculadora = new SalidaCalculadora();
        double result = business.calcular(
        ...
        re = new ResponseEntity<SalidaCalculadora>(salidaCalculadora,HttpStatus.OK);
